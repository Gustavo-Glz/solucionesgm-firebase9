                ...
                <v-toolbar flat>
                    ...
                    <v-dialog v-model="dialog" max-width="700px">
                        ...
                        <v-card>
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn class="mb-5" color="secondary" @click="close">Cancelar</v-btn>
                                <v-btn class="mb-5" color="primary" @click="guardar">Guardar</v-btn>
                            </v-card-actions>
                        </v-card>
                    </v-dialog>
                </v-toolbar>
    ...
    methods: {
        ...
        async guardar() {
            try {
                ...
                const productsRef = ref(storage, `productos/${this.producto.imagen.name}`)
                await uploadBytes(productsRef, this.producto.imagen)
                await getDownloadURL(ref(storage, `productos/${this.producto.imagen.name}`)).then((url) => {
